...
exports.default1687215236787 = void 0;
class default1687215236787 {
    constructor() {
        this.name = 'default1687215236787';
    }
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE \`pedidosAnonimo\` (\`id_pedidoAnonimo\` int NOT NULL AUTO_INCREMENT, \`material\` text NULL, \`maquina\` text NULL, \`estado\` text ('pendente', 'aprovado', 'concluido', 'reprovado') NOT NULL, \`arquivo\` longblob NULL, \`medida\` text NULL, \`codigo\` text NULL, \`id_horaDisponivel\` int NULL, \`id_autorAutorizadorAnonimo\` int NULL, PRIMARY KEY (\`id_pedidoAnonimo\`)) ENGINE=InnoDB`);
...
exports.default1687215236787 = default1687215236787;
