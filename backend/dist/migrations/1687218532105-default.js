...
exports.default1687218532105 = void 0;
class default1687218532105 {
    constructor() {
        this.name = 'default1687218532105';
    }
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE \`pedidos\` DROP COLUMN \`prioridade\``);
        await queryRunner.query(`ALTER TABLE \`pedidos\` ADD \`prioridade\` enum ('baixa', 'media', 'alta') NOT NULL`);
        await queryRunner.query(`DROP TABLE \`pedidosAnonimo\``);
        await queryRunner.query(`DROP TABLE \`horaDisponivel\``);
    }
}
exports.default1687218532105 = default1687218532105;
