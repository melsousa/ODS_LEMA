...
exports.default1686421422676 = void 0;
class default1686421422676 {
    constructor() {
        this.name = 'default1686421422676';
    }
    async up(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE \`pedidos\` CHANGE \`estado\` \`estado\` text ('0', '1', '2', '3') NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`pedidos\` DROP COLUMN \`arquivo\``);
        await queryRunner.query(`ALTER TABLE \`pedidos\` ADD \`arquivo\` longblob NULL`);
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE \`pedidos\` DROP FOREIGN KEY \`FK_208826353b1be16c00ea5a9099a\``);
        await queryRunner.query(`ALTER TABLE \`pedidos\` DROP COLUMN \`arquivo\``);
        await queryRunner.query(`ALTER TABLE \`pedidos\` ADD \`arquivo\` text NULL`);
...
exports.default1686421422676 = default1686421422676;
