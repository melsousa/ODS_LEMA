...
exports.default1687213762190 = void 0;
class default1687213762190 {
    constructor() {
        this.name = 'default1687213762190';
    }
    async up(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE \`pedidos\` CHANGE \`prioridade\` \`prioridade\` enum ('baixa', 'media', 'alta') NOT NULL`);
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE \`pedidos\` CHANGE \`prioridade\` \`prioridade\` enum ('0', '1', '2') NOT NULL`);
        await queryRunner.query(`DROP TABLE \`pedidosAnonimo\``);
        await queryRunner.query(`DROP TABLE \`horaDisponivel\``);
    }
}
exports.default1687213762190 = default1687213762190;
