...
exports.default1687212295987 = void 0;
class default1687212295987 {
    constructor() {
        this.name = 'default1687212295987';
    }
    async up(queryRunner) {
        await queryRunner.query(`CREATE TABLE \`pedidos\` (\`id_pedido\` int NOT NULL AUTO_INCREMENT, \`material\` text NULL, \`prioridade\` text ('baixa', 'media', 'alta') NOT NULL, \`maquina\` text NULL, \`estado\` text ('pendente', 'aprovado', 'concluido', 'reprovado') NOT NULL, \`arquivo\` longblob NULL, \`medida\` text NULL, \`id_horaDisponivel\` int NULL, \`id_autorPedido\` int NULL, \`id_autorAutorizador\` int NULL, PRIMARY KEY (\`id_pedido\`)) ENGINE=InnoDB`);
...
exports.default1687212295987 = default1687212295987;
