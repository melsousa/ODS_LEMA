...
exports.default1686355895579 = void 0;
class default1686355895579 {
    constructor() {
        this.name = 'default1686355895579';
    }
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE \`pedidos\` (\`id_pedido\` int NOT NULL AUTO_INCREMENT, \`material\` text NULL, \`prioridade\` text NOT NULL, \`maquina\` text NULL, \`estado\` text NOT NULL, \`arquivo\` longblob NULL, \`medida\` text NULL, \`id_horaDisponivel\` int NULL, \`id_autorPedido\` int NULL, \`id_autorAutorizador\` int NULL, PRIMARY KEY (\`id_pedido\`)) ENGINE=InnoDB`);
...
exports.default1686355895579 = default1686355895579;
