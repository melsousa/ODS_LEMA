...
exports.default1686353972801 = void 0;
class default1686353972801 {
    constructor() {
        this.name = 'default1686353972801';
    }
    async up(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE "pedidos" ALTER COLUMN "estado" SET NOT NULL`);
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE "pedidos" ALTER COLUMN "estado" DROP NOT NULL`);
...
exports.default1686353972801 = default1686353972801;
