...
exports.default1687219058947 = void 0;
class default1687219058947 {
    constructor() {
        this.name = 'default1687219058947';
    }
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE \`pedidos\` (\`id_pedido\` int NOT NULL AUTO_INCREMENT, \`material\` text NULL, \`prioridade\` enum ('baixa', 'media', 'alta') NOT NULL, \`maquina\` text NULL, \`estado\` enum ('pendente', 'aprovado', 'concluido', 'reprovado') NOT NULL, \`arquivo\` longblob NULL, \`medida\` text NULL, \`id_horaDisponivel\` int NULL, \`id_autorPedido\` int NULL, \`id_autorAutorizador\` int NULL, PRIMARY KEY (\`id_pedido\`)) ENGINE=InnoDB`);
...
exports.default1687219058947 = default1687219058947;
